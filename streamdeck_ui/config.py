"""Defines shared configuration variables for the streamdeck-ui-hass project"""
import os
...
STATE_FILE = os.environ.get("STREAMDECK_UI_CONFIG", os.path.expanduser("~/.streamdeck-ui-hass.json"))
